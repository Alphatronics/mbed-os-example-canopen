...
#ifndef CO_FWUPGRADE_H
#define CO_FWUPGRADE_H

/**
 * mbed-os STM32 fwupgrade support
 *
 * @file        CO_driver.h
 * @ingroup     CO_driver
...
#include "CANopen.h" //needed for params CO_t
...
/**
 * Register object dictionary functions for: 
 * OD index 0x1f50 -> Program Download
 */
